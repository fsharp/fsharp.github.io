...
[Akka.NET](http://akkadotnet.github.io/) and
[WebSharper](http://websharper.com/). Some of these are F#-specific, some are general .NET tools with an F# angle, some are products, some
...
- *Packaging*.  Make a package for your library, component or tool. Often this will be a NuGet package, 
  ...
  the Emacs mode for F# is published as a MELPA package. Fable is published as an NPM package.
...
- *Documentation*.  Ensure your project has good documentation. If on GitHub, consider publishing your 
  documentation via GitHub pages. Consider using documentation generation tools and templates used by the [F# Project Scaffolding](https://github.com/fsprojects/ProjectScaffold)
...
Do not develop features in your "master" branch or published NuGet packages.  Instead, use a PR, a feature branch, or a fork,
or a new project, or a component marked Experimental.
...
For example, the [Akka.NET](http://getakka.net/) project started life as a project called "Pigeon" in 
